 ...
 * @author octavian
 */
public class RabinOld implements Algorithm{
    ...
    public RabinOld(String filePath){
        this.filePath = filePath;
    }
    
    public RabinOld(String filePath, BigInteger[] keys){
        this.filePath = filePath;
        this.N = keys[0];
        this.p = keys[1];
        this.q = keys[2];
    ...
    public void decrypt() {
            ...
            BigInteger[] m2 = RabinOld.decodare(result, p, q);
